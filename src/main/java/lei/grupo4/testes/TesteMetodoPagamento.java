...
public class TesteMetodoPagamento {
    public static void main(String[] args){
        ...
        PagamentoDinheiro pagamentoDinheiro = new PagamentoDinheiro(novoPedido.calcularTotal(), 40);
        System.out.println("*".repeat(30));
        Fatura novaFatura = sr.fecharMesa(novoPedido.obterMesa(), pagamentoDinheiro);
        System.out.println(novoPedido);
