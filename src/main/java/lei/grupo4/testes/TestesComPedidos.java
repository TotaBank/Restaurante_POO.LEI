...
public class TestesComPedidos {
    public static void main(String[] args){
        ...
        Reserva novaReserva = sr.criarReserva("Tomás", 4);
        System.out.println("Reserva: " + novaReserva);

        Pedido novoPedido = sr.criarPedido(novaReserva);
        System.out.println(novoPedido);
        System.out.println(novoPedido.obterMesa().mostrarDetalhes());
        System.out.println("*".repeat(30));
        //Adicionar item a pedido
        System.out.println("Adicionar hamburger a pedido.");
        ...
        System.out.println(novoPedido);
        //remover item a pedido
        System.out.println("*".repeat(20));
        System.out.println("Remover hamburger a pedido.");
        sr.removerItemAPedido(novoPedido, hamburgerBemPassado);
        System.out.println(novoPedido);
        //Impossivel fechar pedido sem items
        System.out.println("Tentar fechar conta sem items");
        System.out.println("*".repeat(20));
        System.out.println(novoPedido);
        sr.fecharMesa(novoPedido.obterMesa(), metodoDePagamento);
